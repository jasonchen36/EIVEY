    ...
    grunt.initConfig({
        ...
        handlebars: {
            compile: {
                ...
                dest: '../public/assets/app.handlebars.min.js'
            },
            options: {
        ...
        postcss: {
            base: {
                ...
                dist: {
                    src: '../../public/assets/app.base.min.css'
                }
            },
            main: {
                options: {
                ...
                dist: {
                    src: '../../public/assets/app.main.min.css'
                }
            }
        },
        /*
        ...
        sass: {
            base: {
                files: {
                    '../../public/assets/app.base.min.css': 'sass/app.base.scss'
                },
                options: {
                    style: 'compressed',
                    trace: true
            ...
            main: {
                files: {
                    '../../public/assets/app.main.min.css': 'sass/app.main.scss'
                },
                options: {
                    style: 'compressed',
                    trace: true
